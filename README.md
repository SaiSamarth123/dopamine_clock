...
Before publishing: push to `main`, then set GitHub Pages to the **`gh-pages` branch** (see [STORE_LISTING.md](docs/STORE_LISTING.md)), complete manual items in [QA.md](QA.md), add screenshots per store listing guide.
